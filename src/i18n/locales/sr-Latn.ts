...
const srLatnTranslations: TranslationKeys = {
  ...
  "appProjectTracker": "Praćenje projekata",
  "appProjectTrackerDesc": "Projekti, podsetnici, fakture i statistika",
  "appDataManagement": "Upravljanje podacima",
  "appDataManagementDesc": "Matični podaci, registri i šifarnici",
  "appCurrentActive": "Aktivno",
  "tabDashboard": "Početna",
  "subTabDefault": "Podrazumevano",
  "subTabStatistic": "Statistika",
  "subTabSummary": "Pregled",
  ...
  "subTabWasteManagement": "Upravljanje otpadom",
  ...
  "tabUsers": "Korisnici",
  "tabServices": "Usluge",
  "tabProvidedServices": "Pružene usluge",
  "providedServicesSummary": "Pregled pruženih usluga",
  "providedServicesStatistics": "Statistika pruženih usluga",
  "totalProvidedServices": "Ukupno usluga",
  "totalValue": "Ukupna vrednost",
  "servicesByStatus": "Usluge po statusu",
  "servicesByCategory": "Usluge po kategoriji / vrsti",
  "topClientsByServices": "Najveći klijenti",
  "monthlyServicesTrend": "Mesečni trend pruženih usluga",
  "wasteComparisonByYear": "Poređenje količine otpada po mesecima kroz godine",
  "completionRate": "Stopa realizacije",
  ...
  "colPermit": "Dozvola",
  "colPermitNumber": "Broj dozvole",
  "colPermitType": "Tip dozvole",
  "colStartDate": "Datum početka",
  "colEndDate": "Datum isteka",
  "lblIndexNumber": "Indeksni broj",
  "phIndexNumber": "npr. 19-00-00123/2023-05",
  "lblPermitNumber": "Broj dozvole",
  "phPermitNumber": "npr. DOZ-2023-089",
  "lblPermitType": "Tip dozvole",
  "phSelectPermitType": "Izaberite tipove dozvole...",
  "filterPermitType": "Tip dozvole",
  "permitTypeSakupljanje": "Sakupljanje",
  "permitTypeTransport": "Transport",
  "permitTypeSkladistenje": "Skladištenje",
  "permitTypeTretman": "Tretman",
  "permitTypeOdlaganje": "Odlaganje",
  "lblEndDate": "Datum isteka",
  "lblPermit": "Dozvola",
  "phSelectPermit": "Izaberite dozvolu...",
  "emptyPermits": "Nema pronađenih dozvola.",
  ...
  "statusActivePermit": "Važeća",
  "daysRemaining": "dana do isteka",
  "daysExpired": "dana istekla",
  "linkedReminders": "Povezani podsetnici",
  "btnAddReminderForPermit": "Dodaj podsetnik za dozvolu",
  "noPermit": "Nema (Bez dozvole)",
  "btnNewProvidedService": "Nova pružena usluga",
  "providedServicesListTitle": "Pružene usluge",
  "emptyProvidedServices": "Nema pronađenih pruženih usluga.",
  "modalNewProvidedService": "Nova pružena usluga",
  "modalEditProvidedService": "Izmena pružene usluge",
  "colScheduledDate": "Planirani datum",
  "colCompletionDate": "Datum završetka",
  "colLocation": "Lokacija",
  "colPrice": "Cena",
  "lblLocation": "Lokacija / Objekat",
  "phLocation": "Unesite lokaciju ili objekat...",
  "lblScheduledDate": "Planirani datum",
  "lblCompletionDate": "Datum završetka",
  "lblPrice": "Cena",
  "confirmDeleteProvidedService": "Da li ste sigurni da želite da obrišete ovaj zapis o pruženoj usluzi?",
  "permissionDeniedProvidedServices": "Nemate dozvolu za upravljanje pruženim uslugama.",
  "filterWasteManagement": "Upravljanje otpadom",
  "filterAllStatus": "Sve",
  "statusPlanned": "Planirano",
  "inProgressServices": "U toku",
  "plannedServices": "Planirano",
  "lblMonthly": "Mesečno",
  "lblCumulative": "Kumulativno",
  "wasteQuantityAnalysis": "Analiza količine otpada",
  "annualWasteAnalysis": "Godišnja analiza otpada",
  "monthlyWasteAnalysis": "Mesečna analiza otpada",
  "lblSelectMonth": "Izaberite mesec",
  "lblSelectYear": "Izaberite godinu",
  "totalWasteMonth": "Ukupno u odabranom mesecu",
  "totalWasteYear": "Ukupno u odabranoj godini",
  "wasteClientsCount": "Broj klijenata",
  "wasteEntriesCount": "Broj preuzimanja",
  "wasteQuantityByClient": "Količina otpada po klijentima",
  "totalWasteQuantity": "Ukupan otpad",
  "noWasteInMonth": "Nema evidentiranih zapisa o otpadu za izabrani mesec.",
  "alertServiceNameRequired": "Naziv usluge je obavezan.",
  "alertServiceCodeRequired": "Šifra usluge je obavezna.",
  "btnEditCustomDataModel": "Uredi model prilagođenih podataka",
  "modalCustomDataModelTitle": "Model prilagođenih podataka",
  "modalCustomDataModelDesc": "Definišite prilagođena polja i njihove tipove podataka za ovu uslugu.",
  "btnAddField": "Dodaj polje",
  "lblFieldName": "Naziv polja",
  "phFieldName": "npr. Vrsta otpada, Količina (kg), Broj uzoraka",
  "lblFieldType": "Tip polja",
  "lblUnit": "Jedinica mere (opciono)",
  "phUnit": "npr. kg, t, m³, l, h, kom",
  "typeText": "Tekst",
  "typeNumber": "Broj",
  ...
  "colCustomData": "Prilagođeni podaci",
  "lblNoneOptional": "Nema (opciono)",
  "lblNone": "Nema",
  ...
  "lblInvoiceType": "Tip fakture",
  "typeStandard": "Standardna faktura",
  "typeAdvance": "Avansni račun (Avans)",
  "typeFinal": "Konačni račun / Ostatak",
  "typePartial": "Delimični račun",
  "colInvoiceType": "Tip",
  "colLinkedInvoices": "Povezane fakture",
  "lblParentInvoice": "Povezana / Osnovna faktura",
  "lblLinkedInvoices": "Povezane fakture",
  "lblLinkedAdvanceInvoice": "Povezani avansni račun",
  "lblLinkedFinalInvoice": "Povezani konačni računi",
  "phSelectParentInvoice": "Izaberite fakturu za povezivanje...",
  "btnUnlinkInvoiceRelation": "Raskini vezu",
  "filterInvoiceType": "Tip fakture",
  "filterAllInvoiceTypes": "Svi tipovi",
  "filterLinkedStatus": "Status povezanosti",
  "filterAllLinks": "Sve fakture",
  "filterLinkedOnly": "Samo povezane",
  "filterIndependentOnly": "Samo samostalne",
  "badgeAdvance": "Avans",
  "badgeFinal": "Konačni",
  "badgePartial": "Deo",
  "badgeLinked": "Povezana",
  "advancePaid": "Uplaćen avans",
  "remainingBalance": "Preostalo za naplatu",
  "totalContract": "Ukupan ugovoren iznos",
  ...
  "btnLink": "Poveži",
  "btnUnlinkReminder": "Prekini vezu sa podsetnikom",
  ...
  "editorUndo": "Poništi",
  "editorRedo": "Ponovi",
  "editorMentionUser": "Spomeni korisnika (@)",
  "editorMentionSearchPlaceholder": "Pretraži korisnika...",
  "menuNotifications": "Obaveštenja",
  "notificationsTitle": "Obaveštenja",
  "notificationsMarkAllRead": "Označi sve kao pročitano",
  "notificationsClearAll": "Obriši sve",
  "noNotifications": "Nema obaveštenja",
  "noNotificationsDesc": "Nemate novih obaveštenja! Kada vas neko spomene u beleškama projekta, pojaviće se ovde.",
  "notificationMentionedIn": "vas je spomenuo/la u projektu",
  "notificationJustNow": "Upravo",
  "notificationTimeAgo": "pre",
  "btnCancel": "Otkaži",
  "btnSave": "Sačuvaj",
  ...
  "btnTableOptions": "Opcije tabele",
  "btnRefresh": "Osveži",
  "lblTableOptions": "Opcije tabele",
  "lblRowsPerPage": "Redova po stranici",
  "lblRowsPerPageOptions": "Opcije broja redova",
  "lblEditOptions": "Izmeni opcije",
  "lblCustomizeRowsPerPageHelp": "Brojevi odvojeni zarezom (npr. 15, 25, 50)",
  "btnResetDefault": "Vrati na podrazumevano",
  "lblColumns": "Kolone",
  ...
  "lblDateRange": "Datumski raspon",
  "lblFromDate": "Od datuma",
  "lblToDate": "Do datuma",
  "lblThisMonth": "Ovaj mesec",
  "lblDateField": "Polje datuma",
  "btnClearDate": "Poništi datum",
  "filterAll": "Sve",
