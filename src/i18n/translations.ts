...
export interface TranslationKeys {
  ...
  lblPermitType: string;
  phSelectPermitType: string;
  filterPermitType: string;
  permitTypeSakupljanje: string;
  permitTypeTransport: string;
  permitTypeSkladistenje: string;
  permitTypeTretman: string;
  permitTypeOdlaganje: string;
  lblEndDate: string;
  lblPermit: string;
